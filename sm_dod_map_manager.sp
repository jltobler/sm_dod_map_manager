...
public void rotation_menu(TopMenu, TopMenuAction action, TopMenuObject, int p, char[] buf, int max)
{
	switch (action) {
...
public void OnPluginStart()
{
	...
	mm_time_limit = CreateConVar("mm_time_limit", "25", "Time limit set by map manager");
	mm_win_limit = CreateConVar("mm_win_limit", "5", "Win limit set by map manager");
